  ...
  return (
    <>
      <BaggageCard
        ...
        sizes="Medidas máximas: 45 x 35 x 20 cm (alto, largo y ancho)"
      ...
      <BaggageCard
        ...
        sizes="Medidas máximas: no debe exceder los 158cm lineales (largo + ancho + alto)."
        extra="Peso máximo: 23 kg en Clase económica y 32 kg en business class."
      />
    </>
  );
}
